...
import { BarChart2, Star, TrendingUp, Menu, X, LogIn, UserPlus, ChevronDown, LogOut, User, Bell, Globe, PieChart, Layers, Building2, Newspaper, Settings, BookOpen, DollarSign, Pickaxe } from 'lucide-react'
      ...
      <div className="max-w-screen-2xl mx-auto px-4">
          ...
          <div className="hidden md:flex items-center gap-1 ml-4">
            ...
            <div className="relative" ref={marketDropRef}>
              <button
                ...
                className={cn(
                  ...
                  (pathname === '/indices' || pathname === '/funds' || pathname === '/global-markets' || pathname === '/commodities')
                    ? 'bg-blue-50 text-blue-700'
                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'
                )}
              >
            ...
            <div className="relative" ref={resourceDropRef}>
              ...
              >
                ...
                Resources
                <ChevronDown className={cn('w-3.5 h-3.5 transition-transform', resourceDropOpen && 'rotate-180')} />
              </button>
        ...
        {menuOpen && (
          <div className="md:hidden py-2 border-t border-gray-100">
            ...
            <div className="px-4 py-1 text-[10px] font-bold text-gray-400 uppercase tracking-wider mt-1">Resources</div>
