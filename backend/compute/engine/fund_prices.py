...
FUNDS: list[dict] = [
    ...
    dict(asx_code="MLT",  fund_name="Milton Corporation",                          fund_type="LIC", asset_class="Australian Equities", index_tracked=None, fund_manager="Milton",      mer_pct=0.0011, funds_under_mgmt_bn=3.8, distribution_freq="semi-annual", is_hedged=False),
...
def fetch_fund_data(ticker: str, start_date: date, end_date: date) -> pd.DataFrame | None:
    try:
