...
ALLOWED_FIELDS: dict[str, dict] = {
    ...
    "return_2y":   {"col": "u.return_2y",   "scale": 0.01, "type": "number", "label": "Return 2Y %",   "unit": "%", "cat": "Returns"},
    "return_3y":   {"col": "u.return_3y",   "scale": 0.01, "type": "number", "label": "Return 3Y %",   "unit": "%", "cat": "Returns"},
    "return_4y":   {"col": "u.return_4y",   "scale": 0.01, "type": "number", "label": "Return 4Y %",   "unit": "%", "cat": "Returns"},
    "return_5y":   {"col": "u.return_5y",   "scale": 0.01, "type": "number", "label": "Return 5Y %",   "unit": "%", "cat": "Returns"},
    "return_6y":   {"col": "u.return_6y",   "scale": 0.01, "type": "number", "label": "Return 6Y %",   "unit": "%", "cat": "Returns"},
    "return_7y":   {"col": "u.return_7y",   "scale": 0.01, "type": "number", "label": "Return 7Y %",   "unit": "%", "cat": "Returns"},
    "return_8y":   {"col": "u.return_8y",   "scale": 0.01, "type": "number", "label": "Return 8Y %",   "unit": "%", "cat": "Returns"},
    "return_9y":   {"col": "u.return_9y",   "scale": 0.01, "type": "number", "label": "Return 9Y %",   "unit": "%", "cat": "Returns"},
...
SORTABLE_COLS: dict[str, str] = {
    ...
    "return_2y":          "u.return_2y",
    "return_3y":          "u.return_3y",
    "return_4y":          "u.return_4y",
    "return_5y":          "u.return_5y",
    "return_6y":          "u.return_6y",
    "return_7y":          "u.return_7y",
    "return_8y":          "u.return_8y",
    "return_9y":          "u.return_9y",
...
def build_screener_sql(req: ScreenerRequest, scope=None,
    ...
    data_sql = f"""
        SELECT
            ...
            -- The longer horizons. V2 governs every horizon CAGR, so the six
            -- that only ever appeared in the field catalogue must be fetched
            -- like the rest of them.
            u.ebitda_cagr_3y, u.ebitda_cagr_5y,
            u.fcf_cagr_3y, u.fcf_cagr_5y,
            u.bvps_cagr_3y, u.bvps_cagr_5y,
            ...
            u.avg_gross_margin_3y, u.avg_gross_margin_5y,
            u.avg_ebitda_margin_3y, u.avg_ebitda_margin_5y,
            u.avg_operating_margin_3y, u.avg_operating_margin_5y,
            u.avg_net_margin_3y, u.avg_net_margin_5y,
            u.avg_eps_growth_3y, u.avg_eps_growth_5y,
            u.roic,
...
async def batch_screener(
    ...
    sql = f"""
        SELECT
            ...
            u.roe, u.roa, u.roce, u.avg_roe_3y,
            u.revenue_growth_1y, u.revenue_growth_3y_cagr, u.revenue_cagr_5y,
            u.earnings_growth_1y, u.earnings_growth_3y_cagr, u.eps_growth_3y_cagr,
            u.revenue_growth_yoy_q, u.eps_growth_yoy_q,
            u.revenue_growth_hoh, u.net_income_growth_hoh, u.eps_growth_hoh,
            u.debt_to_equity, u.current_ratio, u.net_debt, u.total_debt,
            u.book_value_per_share, u.total_assets, u.total_equity,
            ...
            u.revenue_cagr_7y, u.revenue_cagr_10y, u.net_income_cagr_5y,
            u.eps_cagr_5y, u.ebitda_cagr_3y, u.ebitda_cagr_5y,
            u.fcf_cagr_3y, u.fcf_cagr_5y, u.bvps_cagr_3y, u.bvps_cagr_5y,
            u.composite_score, u.value_score, u.quality_score,
            u.growth_score, u.momentum_score, u.income_score,
            u.avg_roe_5y, u.avg_roa_3y, u.avg_roa_5y,
            u.avg_roce_3y, u.avg_roce_5y, u.avg_roic_3y, u.avg_roic_5y,
            u.avg_gross_margin_3y, u.avg_gross_margin_5y,
            u.avg_ebitda_margin_3y, u.avg_ebitda_margin_5y,
            u.avg_operating_margin_3y, u.avg_operating_margin_5y,
            u.avg_net_margin_3y, u.avg_net_margin_5y,
