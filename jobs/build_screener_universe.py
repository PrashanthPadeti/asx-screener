...
def load_company(cur, asx_code: str) -> dict:
    cur.execute("""
        SELECT asx_code, company_name, sector, industry, sub_industry,
               gics_code, listing_date, status, is_foreign,
               description, website, employee_count, registered_office,
               share_registry, principal_activities, market_cap_group,
               asx_300, asx_200, asx_100, asx_50, asx_20
...
def build_row(asx_code: str, cur) -> dict:
    ...
    row = {
        ...
        "market_cap_group":     g(co, "market_cap_group"),
        ...
        "all_time_high":        g(dm, "all_time_high"),
        "all_time_low":         g(dm, "all_time_low"),
        ...
        "dma_50_ratio":         g(dm, "dma_50_ratio"),
        "dma_200_ratio":        g(dm, "dma_200_ratio"),
        "price_to_sma20":       g(dm, "price_to_sma20"),
        ...
        "adx":                  g(dm, "adx"),
        "di_plus":              g(dm, "di_plus"),
        "di_minus":             g(dm, "di_minus"),
        "cci":                  g(dm, "cci"),
